...
var b = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t4, s4, i4) {
    ...
    return { get() {
      ...
      const r6 = e5 == null ? void 0 : e5.call(this);
  ...
  _$Ev() {
    var _a6;
    this._$Eg = new Promise((t4) => this.enableUpdating = t4), this._$AL = /* @__PURE__ */ new Map(), this._$E_(), this.requestUpdate(), (_a6 = this.constructor.l) == null ? void 0 : _a6.forEach((t4) => t4(this));
  }
  addController(t4) {
    var _a6, _b3;
    ((_a6 = this._$ES) != null ? _a6 : this._$ES = []).push(t4), void 0 !== this.renderRoot && this.isConnected && ((_b3 = t4.hostConnected) == null ? void 0 : _b3.call(t4));
  }
  removeController(t4) {
    var _a6;
    (_a6 = this._$ES) == null ? void 0 : _a6.splice(this._$ES.indexOf(t4) >>> 0, 1);
  }
  _$E_() {
  ...
  connectedCallback() {
    var _a6, _b3;
    (_a6 = this.renderRoot) != null ? _a6 : this.renderRoot = this.createRenderRoot(), this.enableUpdating(true), (_b3 = this._$ES) == null ? void 0 : _b3.forEach((t4) => {
      var _a7;
  ...
  disconnectedCallback() {
    var _a6;
    (_a6 = this._$ES) == null ? void 0 : _a6.forEach((t4) => {
      var _a7;
  ...
  _$EO(t4, s4) {
    ...
    if (void 0 !== e5 && true === i4.reflect) {
      const r6 = (void 0 !== ((_a6 = i4.converter) == null ? void 0 : _a6.toAttribute) ? i4.converter : u).toAttribute(s4, i4.type);
  ...
  _$AK(t4, s4) {
    ...
    if (void 0 !== e5 && this._$Em !== e5) {
      const t5 = i4.getPropertyOptions(e5), r6 = "function" == typeof t5.converter ? { fromAttribute: t5.converter } : void 0 !== ((_a6 = t5.converter) == null ? void 0 : _a6.fromAttribute) ? t5.converter : u;
  ...
  requestUpdate(t4, s4, i4, e5 = false, r6) {
    var _a6;
    if (void 0 !== t4) {
      if (i4 != null ? i4 : i4 = this.constructor.getPropertyOptions(t4), !((_a6 = i4.hasChanged) != null ? _a6 : f)(e5 ? r6 : this[t4], s4))
        return;
      this.C(t4, s4, i4);
    }
  ...
  performUpdate() {
    ...
    const s4 = this._$AL;
    try {
      t4 = this.shouldUpdate(s4), t4 ? (this.willUpdate(s4), (_a6 = this._$ES) == null ? void 0 : _a6.forEach((t5) => {
        var _a7;
  ...
  _$AE(t4) {
    var _a6;
    (_a6 = this._$ES) == null ? void 0 : _a6.forEach((t5) => {
      var _a7;
...
var _a2;
b.elementStyles = [], b.shadowRootOptions = { mode: "open" }, b[d("elementProperties")] = /* @__PURE__ */ new Map(), b[d("finalized")] = /* @__PURE__ */ new Map(), p == null ? void 0 : p({ ReactiveElement: b }), ((_a2 = a.reactiveElementVersions) != null ? _a2 : a.reactiveElementVersions = []).push("2.0.1");
...
var P = (t4, i4) => {
  ...
  for (let i5 = 0; i5 < s4; i5++) {
    ...
    for (; y3 < s5.length && (c4.lastIndex = y3, u3 = c4.exec(s5), null !== u3); )
      y3 = c4.lastIndex, c4 === f2 ? "!--" === u3[1] ? c4 = v : void 0 !== u3[1] ? c4 = _ : void 0 !== u3[2] ? ($.test(u3[2]) && (r6 = RegExp("</" + u3[2], "g")), c4 = m) : void 0 !== u3[3] && (c4 = m) : c4 === m ? ">" === u3[0] ? (c4 = r6 != null ? r6 : f2, d3 = -1) : void 0 === u3[1] ? d3 = -2 : (d3 = c4.lastIndex - u3[2].length, a3 = u3[1], c4 = void 0 === u3[3] ? m : '"' === u3[3] ? g : p2) : c4 === g || c4 === p2 ? c4 = m : c4 === v || c4 === _ ? c4 = f2 : (c4 = m, r6 = void 0);
...
function N(t4, i4, s4 = t4, e5) {
  ...
  return (h3 == null ? void 0 : h3.constructor) !== o5 && ((_b2 = h3 == null ? void 0 : h3._$AO) == null ? void 0 : _b2.call(h3, false), void 0 === o5 ? h3 = void 0 : (h3 = new o5(t4), h3._$AT(t4, s4, e5)), void 0 !== e5 ? ((_c = s4._$Co) != null ? _c : s4._$Co = [])[e5] = h3 : s4._$Cl = h3), void 0 !== h3 && (i4 = N(t4, h3._$AS(t4, i4.values), h3, e5)), i4;
}
var S2 = class {
  constructor(t4, i4) {
  ...
  _$AI(t4, i4 = this, s4, e5) {
    ...
    if (void 0 === h3)
      ...
      for (t4 = h3[0], n5 = 0; n5 < h3.length - 1; n5++)
        r6 = N(this, e6[s4 + n5], i4, n5), r6 === w && (r6 = this._$AH[n5]), o5 || (o5 = !c3(r6) || r6 !== this._$AH[n5]), r6 === T ? t4 = T : t4 !== T && (t4 += (r6 != null ? r6 : "") + h3[n5 + 1]), this._$AH[n5] = r6;
    }
    o5 && !e5 && this.O(t4);
  }
  O(t4) {
...
var _a3;
Z == null ? void 0 : Z(V, M), ((_a3 = t2.litHtmlVersions) != null ? _a3 : t2.litHtmlVersions = []).push("3.0.2");
var j = (t4, i4, s4) => {
  var _a6, _b2;
...
function n4(t4) {
  return (e5, o5) => "object" == typeof o5 ? r5(t4, e5, o5) : ((t5, e6, o6) => {
    ...
    return e6.constructor.createProperty(o6, r6 ? __spreadProps(__spreadValues({}, t5), { wrapped: true }) : t5), r6 ? Object.getOwnPropertyDescriptor(e6, o6) : void 0;
  })(t4, e5, o5);
}

// src/hello.ts
var SimpleGreeting = class extends s3 {
  constructor() {
    super(...arguments);
    this.name = "World";
  }
